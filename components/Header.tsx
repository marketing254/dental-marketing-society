...
const NAV: NavItem[] = [
  { href: "/about", label: "About Us" },
  {
    ...
    label: "Events",
    drop: [
      { href: "/events#upcoming", label: "Upcoming Webinars", sub: "Register & earn free CE", icon: "calendar" },
      { href: "/events#archive", label: "Webinar Replays", sub: "Watch any session on demand", icon: "replay" },
    ],
  },
