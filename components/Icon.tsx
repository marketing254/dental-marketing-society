...
// Stroke icon set ported from the original site's SVG sprite.
const PATHS: Record<string, React.ReactNode> = {
  tooth: (
    <>
      <path d="M12 5.5c-1.5-2-4-2.6-6-1.5C3.8 5.2 3 8 4 12c.7 2.8 1 6.5 2.5 6.5 1.4 0 1.3-3 2.4-3s1 3 2.4 3c1.3 0 1.6-2.4 2.2-4.8" />
      <path d="M12 5.5c1.5-2 4-2.6 6-1.5 1.7 1 2.4 3.2 1.8 6.2" />
    </>
  ),
  users: (
    <>
  ...
  research: <path d="M9 11H3v10h6zM15 7H9v14h6zM21 3h-6v18h6z" />,
  bell: (
    <>
